...
import { TaxonomyTab } from '@/components/content/TaxonomyTab';
    ...
    <div className="min-h-screen bg-brand-cream">
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <h1 className="text-3xl font-bold text-brand-navy mb-4">Taxonomy Management</h1>
          <p className="text-gray-600 mb-8">Ensure products are categorized correctly for better discoverability.</p>
