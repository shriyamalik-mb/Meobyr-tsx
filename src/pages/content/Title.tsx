...
import { TitleTab } from '@/components/content/TitleTab';
    ...
    <div className="min-h-screen bg-brand-cream">
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <h1 className="text-3xl font-bold text-brand-navy mb-4">Title Management</h1>
          <p className="text-gray-600 mb-8">Optimize your product titles for better search visibility and conversion.</p>
